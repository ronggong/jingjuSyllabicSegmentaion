...
if mth_ODF == 'jan':
    ...
    filename_keras_cnn_0  = 'keras.cnn_syllableSeg_jan_deep_class_weight_mfccBands_2D_all_artist_filter_split.h5'
    cnnModel_name         = 'jan_deep_old+new_artist_filter_split'
    ...
    if fusion:
        ...
        if filter_shape == 'temporal':
            ...
            if layer2 == 20:
                ...
                # layer2 32 nodes
                filename_keras_cnn_0    = 'keras.cnn_syllableSeg_jordi_temporal_class_weight_with_conv_dense_mfccBands_2D_artist_filter_split.h5'
            ...
            if layer2 == 20:
                ...
                # layer2 32 nodes
                filename_keras_cnn_0  = 'keras.cnn_syllableSeg_jordi_timbral_class_weight_with_conv_dense_filter_mfccBands_2D_artist_filter_split.h5'
                ...
                cnnModel_name          = 'jordi_timbral_old+new_artist_filter_split'
