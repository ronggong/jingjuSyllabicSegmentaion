...
def getTestTrainRecordingsArtistAlbumFilter():
    ...
    testNacta = [['danAll', 'daeh-Yang_Yu_huan-Tai_zhen_wai_zhuan-lon'], ['danAll', 'dagbz-Feng_xiao_xiao-Yang_men_nv_jiang-lon'],
     ['danAll', 'daspd-Du_shou_kong-Wang_jiang_ting-upf'], ['danAll', 'daspd-Hai_dao_bing-Gui_fei_zui_jiu01-lon'],
     ['danAll', 'daxp-Guan_Shi_yin-Tian_nv_san_hua-lon'], ['danAll', 'daxp-Meng_ting_de-Mu_Gui_ying_gua_shuai01-upf'],
     ['laosheng', 'lseh-Wei_guo_jia-Hong_yang_dong01-lon'], ['laosheng', 'lsxp-Guo_liao_yi-Wen_zhao_guan01-upf'],
     ['laosheng', 'lsxp-Huai_nan_wang-Huai_he_ying01-lon'], ['laosheng', 'lsxp-Jiang_shen_er-San_jia_dian01-1-upf'],
     ['laosheng', 'lsxp-Jiang_shen_er-San_jia_dian01-2-upf'], ['laosheng', 'lsxp-Wo_zheng_zai-Kong_cheng_ji01-upf']]
    testNacta2017 = [['20170327LiaoJiaNi', 'lseh-Niang_zi_bu-Sou_gu_jiu-nacta'],
     ['20170327LiaoJiaNi', 'lseh-Yi_lun_ming-Wen_zhao_guan-nacta'],
     ['20170327LiaoJiaNi', 'lsxp-Jiang_shen_er-San_jia_dian-nacta'],
