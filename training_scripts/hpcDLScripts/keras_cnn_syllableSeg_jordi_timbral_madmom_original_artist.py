...
if __name__ == '__main__':
    ...
    filename_train_validation_set = '/scratch/rgongcnnSyllableSeg_jordi_timbral_madmom_original_artist/syllableSeg/feature_all_artist_filter_madmom.h5'
    ...
    # filename_train_validation_set = '/scratch/rgongcnnSyllableSeg_jordi_timbral_madmom_original/syllableSeg/feature_all_ismir_madmom.h5'
    ...
    #
    # file_path_model = '../../temp/keras.cnn_syllableSeg_jordi_timbral_mfccBands_2D_all_artist_filter_madmom.h5'
    # file_path_log = '../../temp/keras.cnn_syllableSeg_jordi_timbral_mfccBands_2D_all_artist_filter_madmom.csv'
    #
    ...
    for running_time in range(5):
        ...
        file_path_model = '/homedtic/rgong/cnnSyllableSeg/out/keras.cnn_syllableSeg_jordi_timbral_mfccBands_2D_all_artist_filter_madmom_early_stopping_more_params'+str(running_time)+'.h5'
        file_path_log = '/homedtic/rgong/cnnSyllableSeg/out/log/keras.cnn_syllableSeg_jordi_timbral_mfccBands_2D_all_artist_filter_madmom_early_stopping_more_params'+str(running_time)+'.csv'
