...
if __name__ == '__main__':
    ...
    # filename_train_validation_set = '/scratch/rgongcnnSyllableSeg_jan_madmom_original_batchNorm/syllableSeg/feature_all_artist_filter_madmom.h5'
    ...
    filename_train_validation_set = '/scratch/rgongcnnSyllableSeg_jan_madmom_original_batchNorm/syllableSeg/feature_all_ismir_madmom.h5'
    ...
    for running_time in range(5):
        ...
        # file_path_model = '/homedtic/rgong/cnnSyllableSeg/out/keras.cnn_syllableSeg_jan_class_weight_mfccBands_2D_all_artist_filter_madmom_early_stopping'+str(running_time)+'.h5'
        # file_path_log = '/homedtic/rgong/cnnSyllableSeg/out/log/keras.cnn_syllableSeg_jan_class_weight_mfccBands_2D_all_artist_filter_madmom_early_stopping'+str(running_time)+'.csv'

        file_path_model = '/homedtic/rgong/cnnSyllableSeg/out/keras.cnn_syllableSeg_jan_ismir_batchNorm' + str(
            running_time) + '.h5'
        file_path_log = '/homedtic/rgong/cnnSyllableSeg/out/log/keras.cnn_syllableSeg_jan_ismir_batchNorm' + str(
            running_time) + '.csv'
