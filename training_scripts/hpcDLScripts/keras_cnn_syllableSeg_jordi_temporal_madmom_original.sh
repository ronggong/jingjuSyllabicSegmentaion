...
# ----------------------------------
start=`date +%s`
cp -rp /homedtic/rgong/cnnSyllableSeg/syllableSeg/feature_all_artist_filter_madmom.h5 /scratch/rgongcnnSyllableSeg_jordi_temporal_madmom_original/syllableSeg/
end=`date +%s`
...
python /homedtic/rgong/cnnSyllableSeg/jingjuSyllabicSegmentation/training_scripts/hpcDLScripts/keras_cnn_syllableSeg_jordi_temporal_madmom_original.py
