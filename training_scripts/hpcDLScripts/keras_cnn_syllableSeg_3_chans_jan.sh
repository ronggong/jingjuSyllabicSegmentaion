...
mkdir /scratch/rgongcnnSyllableSeg_jan/error
mkdir /scratch/rgongcnnSyllableSeg_jan/script
mkdir /scratch/rgongcnnSyllableSeg_jan/out

# Thir, copy the experiment's data:
# ----------------------------------
cp -rp /homedtic/rgong/cnnSyllableSeg/syllableSeg/* /scratch/rgongcnnSyllableSeg_jan/syllableSeg
...
python /homedtic/rgong/cnnSyllableSeg/keras_cnn_syllableSeg_3_chans_jan.py

# Copy data back, if any
# ----------------------
printf "rgongcnnSyllableSeg_jan processing done. Moving data back\n"
cp -rf /scratch/rgongcnnSyllableSeg_jan/out/* /homedtic/rgong/cnnSyllableSeg/out
