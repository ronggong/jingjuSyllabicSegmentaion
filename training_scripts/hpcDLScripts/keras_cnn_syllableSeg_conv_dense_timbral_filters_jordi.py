...
def train_model(filter_density_1, filter_density_2,
    ...
    filename_train_validation_set = '/scratch/rgongcnnSyllableSeg_timbral/syllableSeg/feature_all_nacta_ismir_split.h5'
...
if __name__ == '__main__':
    ...
    file_path_model = '/homedtic/rgong/cnnSyllableSeg/out/keras.cnn_syllableSeg_jordi_timbral_class_weight_with_conv_dense_filter_mfccBands_2D_ismir_split.h5'
    file_path_log = '/homedtic/rgong/cnnSyllableSeg/out/log/keras.cnn_syllableSeg_jordi_timbral_class_weight_with_conv_dense_filter_mfccBands_2D_ismir_split.csv'
