...
# ----------------------------------
start=`date +%s`
cp -rp /homedtic/rgong/cnnSyllableSeg/syllableSeg/feature_all_riyaz.h5 /scratch/rgongcnnSyllableSeg_jan_deep_riyaz20/syllableSeg/
end=`date +%s`
...
python /homedtic/rgong/cnnSyllableSeg/jingjuSyllabicSegmentaion/training_scripts/hpcDLScripts/keras_cnn_syllableSeg_timbral_riyaz20.py
