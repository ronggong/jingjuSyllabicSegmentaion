...
def train_model(filter_density, dropout, input_shape, file_path_model, filename_log):
    ...
    filename_train_validation_set = '/scratch/rgongcnnSyllableSeg_jan/syllableSeg/feature_all_artist_split.h5'
...
if __name__ == '__main__':
    ...
    file_path_model = '/homedtic/rgong/cnnSyllableSeg/out/keras.cnn_syllableSeg_jan_class_weight_mfccBands_2D_all_artist_split.h5'
    file_path_log = '/homedtic/rgong/cnnSyllableSeg/out/log/keras.cnn_syllableSeg_jan_class_weight_mfccBands_2D_all_artist_split.csv'
