...
def train_model(filter_density1, filter_density2,
    ...
    filename_train_validation_set = '/scratch/rgongcnnSyllableSeg_jan_deep_riyaz20/syllableSeg/feature_all_riyaz.h5'
...
if __name__ == '__main__':
    ...
    file_path_model = '/homedtic/rgong/cnnSyllableSeg/out/keras.cnn_syllableSeg_timbral_class_weight_mfccBands_2D_all_riyaz.h5'
    file_path_log = '/homedtic/rgong/cnnSyllableSeg/out/log/keras.cnn_syllableSeg_timbral_class_weight_mfccBands_2D_all_riyaz.csv'
