...
# ----------------------------------
start=`date +%s`
cp -rp /homedtic/rgong/cnnSyllableSeg/syllableSeg/feature_all_riyaz30.h5 /scratch/rgongcnnSyllableSeg_jan_deep_riyaz30/syllableSeg/
end=`date +%s`
...
python /homedtic/rgong/cnnSyllableSeg/jingjuSyllabicSegmentaion/training_scripts/hpcDLScripts/keras_cnn_syllableSeg_jan_deep_riyaz30.py
