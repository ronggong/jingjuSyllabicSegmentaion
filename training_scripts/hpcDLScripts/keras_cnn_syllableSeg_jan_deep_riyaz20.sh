...
if [ -d /scratch/rgongcnnSyllableSeg_jan_deep_riyaz20 ]; then
        rm -Rf /scratch/rgongcnnSyllableSeg_jan_deep_riyaz20
fi

# Second, replicate the structure of the experiment's folder:
# -----------------------------------------------------------
mkdir /scratch/rgongcnnSyllableSeg_jan_deep_riyaz20
mkdir /scratch/rgongcnnSyllableSeg_jan_deep_riyaz20/syllableSeg
...
# ----------------------------------
start=`date +%s`
cp -rp /homedtic/rgong/cnnSyllableSeg/syllableSeg/feature_all_riyaz20.h5 /scratch/rgongcnnSyllableSeg_jan_deep_riyaz20/syllableSeg/
end=`date +%s`
...
# Output/Error Text
# ----------------
#$ -o /homedtic/rgong/cnnSyllableSeg/out/cnn_jan_deep_riyaz20.$JOB_ID.out
#$ -e /homedtic/rgong/cnnSyllableSeg/error/cnn_jan_deep_riyaz20.$JOB_ID.err

python /homedtic/rgong/cnnSyllableSeg/jingjuSyllabicSegmentaion/training_scripts/hpcDLScripts/keras_cnn_syllableSeg_jan_deep_riyaz20.py
